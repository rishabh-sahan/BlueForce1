      ...
      <div className="container mx-auto px-4 py-10">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">
                  123 Tech Park, Bengaluru, Karnataka 560001, India
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">contact@blueforce.in</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-400 mt-2">Get the latest updates on new features and services.</p>
          </div>
          <div className="text-center text-gray-400 text-sm">
            <p>&copy; {new Date().getFullYear()} BlueForce. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
